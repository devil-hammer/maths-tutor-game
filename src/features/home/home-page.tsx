      ...
      <section className="grid gap-6 lg:grid-cols-[1.25fr_0.95fr]">
        <div className="rounded-[2.5rem] border-4 border-white bg-white/90 p-6 shadow-[0_18px_60px_rgba(14,165,233,0.2)]">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-sm font-bold uppercase tracking-[0.25em] text-amber-500">Welcome Back</p>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <StatBubble label="Stars" value={profile.stars.toString()} tone="amber" />
          ...
          <div className="mt-6 space-y-4">
            ...
            <ProgressBar
              ...
              colorClassName="bg-gradient-to-r from-amber-400 to-orange-500"
            />
          </div>
